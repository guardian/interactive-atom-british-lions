...
var shareFn = share('The Guardian player-by-player guide to the British Lions 2017 squad','https://gu.com/p/4dzzp');
var detailMobileTemplate = '<div class="detail-item-container" data-id="{{{id}}}" data-loaded="false"><h5>{{{name}}} </h5><ul> <li><strong>Height</strong>{{{heightMetric}}}</li> <li><strong>Weight</strong>{{{weightMetric}}}</li> <li><strong>Age</strong>{{{Age}}}</li></ul>'+detailImgDiv+svgDiv+'<p class="detail-item-description">{{{Description}}}</p></div>';
